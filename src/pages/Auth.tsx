...
export default function Auth() {
  ...
  async function handleGISResponse(response: GoogleCredentialResponse) {
      ...
      >
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-3">
            ...
            <span className="text-3xl font-light tracking-[0.18em] text-white">
              ORAG
            </span>
          </div>
        ...
        >
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <span
                className="flex-1 text-left font-mono text-[11px] tracking-widest uppercase text-white/70
